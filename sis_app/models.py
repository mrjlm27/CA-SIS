...
class Student(Account):
    ...
    student_hobbies = models.TextField(max_length=500, default=None, blank=True, null = True)
    student_likes = models.TextField(max_length=500, default=None, blank=True, null = True)
    student_dislikes = models.TextField(max_length=500, default=None, blank=True, null = True)
    student_shm = models.TextField(max_length=500, default=None, blank=True, null = True)
    student_allergies = models.TextField(max_length=500, default=None, blank=True, null = True)
    student_sd = models.TextField(max_length=500, default=None, blank=True, null = True)
    ...
    student_f_occupation = models.CharField(max_length=128, default=None, blank=True, null = True)
    student_f_employer = models.CharField(max_length=128, default=None, blank=True,null = True)
    student_f_oaddress = models.CharField(max_length=300, default=None, blank=True,null = True)
    ...
    student_m_occupation = models.CharField(max_length=128, default=None, blank=True, null = True)
    student_m_employer = models.CharField(max_length=128, default=None, blank=True, null = True)
    student_m_oaddress = models.CharField(max_length=300, default=None, blank=True, null = True)
...
class GradeReport(models.Model):
    ...
    if datetime.date.today().month <= 5:
        sy = [tuple([x,x]) for x in range(datetime.date.today().year-1,datetime.date.today().year)]
    else:
        sy = [tuple([x,x]) for x in range(datetime.date.today().year,datetime.date.today().year+1)]
    ...
    gradelevel = models.CharField(null=True, blank=True, default=None, max_length=120)
